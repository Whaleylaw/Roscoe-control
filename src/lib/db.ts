...
import { ensureRunnerSecret } from './runner-secret';
...
export function getDatabase(): Database.Database {
  if (!db) {
    ...
    // Runner principal (Phase 11 — RAUTH-01). Peer to AUTH_SECRET / API_KEY:
    // auto-generates `.data/runner.secret` with 0600 perms on first boot.
    ensureRunnerSecret();
