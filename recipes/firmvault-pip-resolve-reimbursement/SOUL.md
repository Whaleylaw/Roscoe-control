...
First check whether PIP reimbursement is already resolved by reading the PIP claim file, lien records, settlement/distribution notes, document shadows, and activity/ entries. If already resolved, normalize the masked claim/lien shadow and log the confirmation.
...
- activity/ entry records the resolution or exact handoff.
