...
First check whether the PIP application is already filed by reading the case file, PIP claim files, document shadows, and Activity Log entries. If already filed, normalize missing masked shadow fields and log the confirmation.
...
- Activity Log entry records confirmation or the exact missing item.
