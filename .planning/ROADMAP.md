...
- [ ] 14-08a-PLAN.md — runner-gc + runner-reconcile + runner-timeout + runner-log-layout pure-logic helpers + tests (RUNNER-12, 13, 14, CONTAINER-03, WORK-07)
...
- [ ] 14-11-PLAN.md — submit + container-started + /api/runner/config routes (RUNNER-06, 11, 13, WORK-06)
...
| 14. Runner Daemon & Container Execution *(v1.2)* | 4/12 | In Progress|  |
