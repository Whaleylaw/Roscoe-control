...
- [x] **Phase 20: Lane-Aware Routing & Unified Blocker Contract** — Make the scheduler prefer active plan lanes over legacy inbox and give legacy dispatch the same structured `awaiting_owner` pause/resume contract as the recipe runner. (ROUTE-01, ROUTE-02, COMPAT-02, COMPAT-03) (completed 2026-04-22)
...
| 20. Lane-Aware Routing & Unified Blocker Contract | 3/3 | Complete   | 2026-04-22 | — |
